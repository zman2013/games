...
public class BarrierDataGenerator extends ApplicationAdapter{
	...
	public void create() {
		...
		enemyInfos.add( new FighterInfo( 302, 0, "assets/images/border/5.png", "assets/images/fighter/301.png", 
				...
				equipments) );
		enemyInfos.add( new FighterInfo( 303, 1, "assets/images/border/2.png", "assets/images/fighter/302.png",
				...
				equipments) );
		enemyInfos.add( new FighterInfo( 304, 2, "assets/images/border/3.png", "assets/images/fighter/303.png",
				...
				equipments) );
		enemyInfos.add( new FighterInfo( 305, 3, "assets/images/border/4.png", "assets/images/fighter/304.png",
				...
				equipments) );
		enemyInfos.add( new FighterInfo( 306, 4, "assets/images/border/2.png", "assets/images/fighter/305.png",
				...
				equipments) );
		enemyInfos.add( new FighterInfo( 30, 5, "assets/images/border/3.png", "assets/images/fighter/306.png",
