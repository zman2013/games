...
public class CommodityDetailActor extends Image{
	...
	public CommodityDetailActor( BagResourceLoader loader ){
	...
	public void draw(Batch batch, float parentAlpha) {
		...
		if( commodityDrawable != null ){
			...
			IntMap<Integer> properties = commodity.getProperties();
			y -= 20;
			for( Entry< Integer> entry : properties.entries() ){
				font.draw( batch, Commodity.getPropertyName(entry.key)+":"+entry.value, x+100, y );
				y -= 18;
			}
		}
